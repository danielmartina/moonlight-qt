...
if !ERRORLEVEL! NEQ 0 goto Error
"C:\Program Files\7-Zip\7z.exe" a %SYMBOLS_FOLDER%\MoonlightDebuggingSymbols-%ARCH%-%VERSION%.zip %SYMBOLS_FOLDER%\*.pdb
if !ERRORLEVEL! NEQ 0 goto Error
...
if !ERRORLEVEL! NEQ 0 goto Error
"C:\Program Files\7-Zip\7z.exe" a %INSTALLER_FOLDER%\MoonlightPortable-%ARCH%-%VERSION%.zip %DEPLOY_FOLDER%\*
if !ERRORLEVEL! NEQ 0 goto Error
